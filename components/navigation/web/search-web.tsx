...
export default function SearchWeb({value}: SearchWebType) {
    ...
    return <div className="w-full flex justify-center fixed bottom-10">
        <div className="w-1/4 flex gap-2 items-center bg-[#e8e8edb3] backdrop-blur-sm rounded-full overflow-hidden p-2">
