...
export default function NavigationWeb() {
    ...
    return <div className="hidden drop-shadow-xs md:flex w-full bg-white/20 backdrop-blur-md fixed px-20 p-1 justify-between items-center">
        ...
        <div className="flex gap-1">
            <Button variant={"ghost"} size={"md"}>Registrieren</Button>
